...
const p = resolve(process.env.SQLITE_DB_PATH || "./data/scolarite.sqlite");
...
CREATE TABLE IF NOT EXISTS teachers(id INTEGER PRIMARY KEY AUTOINCREMENT,first_name TEXT NOT NULL,last_name TEXT NOT NULL,email TEXT NOT NULL UNIQUE,department TEXT NOT NULL DEFAULT '');`);
console.log("Base initialisée :", p);
db.close();